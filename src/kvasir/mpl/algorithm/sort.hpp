...
namespace kvasir {
	namespace mpl {
		namespace detail
		{
			...
			template <class... R, class T, class... Ts, class U0, class U1, class... Us, template<typename...> class Comp>
			...
			template <class... R, class T0, class T1, class T2, class T3, class T4, class T5, class T6,
				...
				class U4, class U5, class U6, class U7, class U8, class U9, class... Us, template<typename...> class Comp>
				...
				list<U0, U1, U2, U3, U4, U5, U6, U7, U8, U9, Us...>, Comp>
			{
				...
				using type = typename merge_impl<typename c::join<c::listify>::template f<list<R...>, typename sub::out>,
					typename c::join<c::listify>::template f <typename sub::left, list<Ts...>>,
					typename c::join<c::listify>::template f <typename sub::right, list<Us...>>, Comp>::type;
			};

			template <class... R, class T, class... Ts, class U, class... Us, template<typename...> class Comp>
			struct merge_impl<list<R...>, list<T, Ts...>, list<U, Us...>, Comp>
				: std::conditional<Comp<T, U>::value,
			...
			template <class T0, class T1, class T2, class T3, class T4, class T5, class T6, class T7,
				class T8, class... Ts, template<typename...> class Comp>
			...
			template <class T0, class T1, class T2, class T3, class T4, class... Ts, template<typename...> class Comp>
			...
			template <class T0, class T1, class T2, class T3, class T4, class T5, class T6, class T7,
				...
				class T16, class T17, class... Ts, template<typename...> class Comp>
			...
			template <class L0, class T0, class T1, class T2, class T3, class T4, class T5, class T6,
				...
				class T15, class T16, class T17, class... Ts, template<typename...> class Comp>
			...
			template <class L0, class L1, class T0, class T1, class T2, class T3, class T4, class T5,
				...
				class T14, class T15, class T16, class T17, class... Ts, template<typename...> class Comp>
			...
			template <class L0, class L1, class L2, class T0, class T1, class T2, class T3, class T4,
				...
				class T13, class T14, class T15, class T16, class T17, class... Ts, template<typename...> class Comp>
			...
			template <class L0, class L1, class L2, class T, class... Ts, template<typename...> class Comp>
			...
			template <
				...
				class T252, class T253, class T254, class T255, typename... Ts, template<typename...> class Comp>
				struct sort_impl<
				list<>,
