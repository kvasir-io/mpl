...
namespace lookup {
	...
	using uint_seq = mc::mpl::equal<mpl::eager::lookup<mpl::call<mpl::make_int_sequence<>,
	                                                             mpl::uint_<Size::value + 1>>,
...
constexpr auto lookup_section = mc::section("lookup", lookup::uint_seq_test);
