...
static_assert(
        std::is_same<kvasir::mpl::eager::bitwise_or<kvasir::mpl::integral_constant<unsigned, 0>,
                                                    kvasir::mpl::integral_constant<unsigned, 1>>,
                     kvasir::mpl::integral_constant<unsigned, 1>>::value,
        "");
static_assert(
        std::is_same<
                kvasir::mpl::bitwise_or<>::template f<kvasir::mpl::integral_constant<unsigned, 0>,
                                                      kvasir::mpl::integral_constant<unsigned, 1>>,
                kvasir::mpl::integral_constant<unsigned, 1>>::value,
        "");
